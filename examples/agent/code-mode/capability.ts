...
import { loadToolsFromDirectory } from "../shared/tools/load.js";

export { renderToolsSdk, ToolCallError } from "./executor.js";
    ...
    async execute({ code }, context) {
      try {
        return {
          ...
          output: await runCodeProgram(code, roster, context),
        };
      } catch (error) {
