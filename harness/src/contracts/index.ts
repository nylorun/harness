...
const commandBase = { requestId: RequestIdSchema, idempotencyKey: IdempotencyKeySchema };
export const MessageEventBodySchema = z
  .object({ ...commandBase, type: z.literal("message"), content: z.string().min(1) })
  .strict();
...
export const SessionCommandSchema = z.discriminatedUnion("type", [
  ...
  z
    ...
    .strict(),
  z.object({ ...commandBase, type: z.literal("cancel"), reason: z.string().optional() }).strict(),
...
export const ExecutorNotificationSchema = z.object({ type: z.literal("work_available") });
