...
function normalizeZodSchema(source: z.ZodType, role: "input" | "output"): ToolSchema<unknown> {
...
function normalizeExplicitSchema(source: ToolSchema<unknown>): ToolSchema<unknown> {
  return Object.freeze({
