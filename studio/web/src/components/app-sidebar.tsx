...
import { Activity, Bot, ChevronRight, CirclePlus, Database, KeyRound, LoaderCircle, ServerOff, Settings } from "lucide-react";
...
export function AppSidebar({ connection, activeAgentId, activeSessionId, settingsActive, vaultActive }: Readonly<{ connection: Connection; activeAgentId?: string; activeSessionId?: string; settingsActive?: boolean; vaultActive?: boolean }>) {
