...
import { Activity, Bot, ChevronRight, CirclePlus, Database, LoaderCircle, ServerOff, Settings } from "lucide-react";
...
export function AppSidebar({ connection, activeAgentId, activeSessionId, settingsActive }: Readonly<{ connection: Connection; activeAgentId?: string; activeSessionId?: string; settingsActive?: boolean }>) {
